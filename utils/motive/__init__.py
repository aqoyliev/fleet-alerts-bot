...
async def crash_still_listed(api_key: str, event_id, occurred_at) -> bool | None:
    ...
    /v2/driver_performance_events entirely, not merely reclassified. Measured on the
    multi-company bot over 2026-07-29..08-01: of 62 crash webhooks alerted on, 59 were
    gone from the API under every event type, 1 had become a near_miss, and the 2 that
    remained type='crash' were the single genuine collision.
